...
import { createChat, getChats, getMessagesByChatId, sendMessage, clearChatMessages } from "../controllers/chat.js";
...
router.delete("/chat/:chatId/clear", isAuth, clearChatMessages);
